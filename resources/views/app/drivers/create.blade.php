...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    <h1 class="h3 mb-0 text-gray-800">Registrar nuevo conductor</h1>
    ...
    <div class="card o-hidden border-0 shadow-lg my-5 col-xl-10">
        <div class="card-body ">
            ...
            <div class="row d-flex justify-content-center">
                <div class="col-xl-10">
                    <div class="p-5">
                        <form class="user" action="{{ route('store_driver') }}" method="POST">@csrf
                            ...
                            <div class="row">
                                ...
                                <div class="col">
                                    <div class="form-group">
                                        <div class="d-flex flex-column">
                                            <label for="fee"><strong>Tarifa por Km</strong></label>
                                            <input type="text" class="form-control bg-light  " name="fee" id="fee">
                                            @error('fee')
                                                <span style="color:red">{{$message}}</span>
                                            @enderror
                                        </div>    
